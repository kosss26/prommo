                    ...
                    setInterval(function () {
                        ...
                        for (var i = 0; i < spriteData[0][nanim][count].length; i++) {
                            ...
                            if (parseInt(spriteData[0][nanim][count][i][9]) !== -1) {
                                if (parseInt(spriteData[0][nanim][count][i][9]) === 100) {
                                    buffcontext_0.drawImage(imagedress,
                                            dressData["100"][PRasa][PDress][0],
                                            dressData["100"][PRasa][PDress][1],
                                            dressData["100"][PRasa][PDress][2],
                                            dressData["100"][PRasa][PDress][3],
                                            Math.round( - dressData["100"][PRasa][PDress][2] / 2),
                                            Math.round( - dressData["100"][PRasa][PDress][3] / 2),
                                            dressData["100"][PRasa][PDress][2],
                                            dressData["100"][PRasa][PDress][3]
                                            );
