...
if (isset($user['level']) && $user['level'] < 2) {
    ?>
    <script>/*nextshowcontemt*/showContent("/main.php?msg=" + decodeURI("Недоступно до 2 уровня"));</script>
    <?php
    exit(0);
}
...
<head>
    <meta charset="UTF-8">
    <title>Поиск противника - Mobitva v1.0</title>
...
<div class="battle-search">
    <div class="battle-header">
        <span><i class="fas fa-search"></i> Поиск противника</span>
    </div>
    ...
    <div class="text-center" style="margin-top: 20px;">
        <div class="battle-button" onclick="huntb_remove()">
            <span><i class="fas fa-times"></i> Отказаться</span>
        </div>
    </div>
</div>
